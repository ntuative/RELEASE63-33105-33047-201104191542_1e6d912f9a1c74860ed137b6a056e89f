package com.sulake.room
{
   ...
   public class RoomObjectManager implements IRoomObjectManager
   {
      ...
      public function createObject(param1:int, param2:uint, param3:String) : IRoomObjectController
      {
         ...
         return this.method_11(String(param1),param3,_loc4_);
      }
      
      private function method_11(param1:String, param2:String, param3:IRoomObjectController) : IRoomObjectController
      {
      ...
      {
         var _loc3_:Map = this.var_443.getValue(param1);
         if(_loc3_ == null && param2)
         {
            _loc3_ = new Map();
            this.var_443.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function reset() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_443.length)
            {
               _loc4_ = this.var_443.getWithIndex(_loc3_) as Map;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
