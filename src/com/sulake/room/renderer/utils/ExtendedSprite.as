package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1804 || param2 != this.var_1805)
         {
      ...
      {
         if(this.var_1452 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_247 || param2 >= this._height)
         {
            return false;
         }
