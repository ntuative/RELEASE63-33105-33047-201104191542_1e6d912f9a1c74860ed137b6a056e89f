package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_224:Boolean = true;
      
      private static const const_1375:Number = 25;
      
      private static const const_1376:Number = 90;
      ...
      private var var_1485:IToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_790 = new Timer(const_1375);
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_364[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1029 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1029 || param1.desktop.height - param1.y < const_1434;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1485.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_364.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1485.getIconLoc(param1.iconId);
      ...
      {
         return this.var_634[this.var_635.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_635[this.var_634.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_635.indexOf(param2);
         if(_loc3_ > -1)
         {
         ...
         this.var_635.push(param2);
         param1.addEventListener(WindowEvent.const_237,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_185,this.windowEventListener);
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_364.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_364.splice(this.var_364.indexOf(param1),1);
            }
         }
      }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_364.length)
         {
            _loc2_ = this._itemList[this.var_364[_loc7_]];
            if(_loc2_.active)
            {
