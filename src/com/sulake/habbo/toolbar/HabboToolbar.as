package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1603:LogoutController;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_266.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1317 = this._config.getKey("client.toolbar.static.enabled","RoomWidgetDimmerUpdateEvent") == "true";
         this.tryInitialize();
      }
      
      private function tryInitialize() : void
      {
         if(this.var_266 && this._windowManager && this._config)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","RoomWidgetDimmerUpdateEvent") == "true")
         {
            this.var_1603 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_117,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1270,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_167,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_574,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1189,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1174,this.onHideWindowEvent);
         this._state = true;
