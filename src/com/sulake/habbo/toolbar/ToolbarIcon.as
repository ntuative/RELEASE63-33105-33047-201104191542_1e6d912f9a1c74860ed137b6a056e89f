package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:String, param6:IEventDispatcher, param7:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1200 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_509 = param1;
         ...
         this._events = param6;
         this.var_305 = param7;
         this.var_1479 = new Timer(40,40);
         this.var_1479.addEventListener(TimerEvent.TIMER,this.updateBouncer);
      ...
      public function set exists(param1:Boolean) : void
      {
         ...
         if(this._region != null)
         {
            this._region.visible = this.var_1201;
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_2489 = int(param1.@window_offset_from_icon);
         this.var_2488 = int(param1.@window_margin);
         this.var_2936 = param1.@label;
         var _loc2_:XMLList = param1.elements("state");
         if(_loc2_.length() > 0)
         {
            if(param1.attribute("state_over").length() > 0)
            {
               this.var_1478 = param1.@state_over;
            }
            if(param1.attribute("state_default").length() > 0)
            {
               this.var_1196 = param1.@state_default;
            }
            _loc3_ = 0;
            while(_loc3_ < _loc2_.length())
            {
               ...
               this.var_1199.push(_loc5_.id);
               this.var_1849.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(this.var_1478 == "-1")
                  {
                     this.var_1478 = _loc5_.id;
                  }
                  if(this.var_1196 == "-1")
                  {
                     this.var_1196 = _loc5_.id;
                  }
               }
               _loc3_++;
            }
         }
         this._state = this.var_1196;
      }
      ...
      {
         var _loc4_:* = null;
         if(this.var_786.indexOf(param1) < 0)
         {
            this.var_786.push(param1);
            _loc4_ = new MenuSettingsItem(param1,param2,param3);
            this.var_1198.push(_loc4_);
         }
      }
      
      public function docksMenu(param1:String) : Boolean
      {
         return this.var_786.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1198[this.var_786.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         ...
         {
            this.var_305.animateWindowIn(this,param1,param2,this.var_787,param3,param4,this.getMenuYieldList(param1));
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_305 != null)
         {
            this.var_305.positionWindow(this,param1,param2,this.var_787,param3,this.getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_305 != null)
         {
            this.var_305.hideWindow(param1,param2,this.var_787,param3);
         }
      }
      ...
      {
         return this.var_1849[this.var_1199.indexOf(param1)];
      }
      ...
      {
         return this.var_2488 + this.var_509.windowMargin;
      }
      ...
      {
         if(this.var_1200 != null && this._icon != null)
         {
            this.var_1200.update();
            this._icon.y = this.var_1200.location;
         }
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(this.var_305)
               {
                  this.var_305.repositionWindow(this.var_787,true);
               }
               if(this._events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_36);
                  _loc4_.iconId = this.var_787;
      ...
      private function updateRegion() : void
      {
         ...
         if(_loc1_)
         {
            ...
            this.var_160 = this.var_1093 + (this.var_509.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_1093 + (this.var_509.iconSize - this._region.width) / 2;
            this.var_160 = (this.var_509.toolbarUsableWidth - this._region.height) / 2;
         }
