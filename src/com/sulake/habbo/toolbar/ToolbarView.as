package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_230 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_68,HabboWindowStyle.const_1216,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1280 = String(_loc9_.relocate_by_drag.@state) == "true";
         if(this.var_1280)
         {
            this._window.addEventListener(WindowMouseEvent.const_42,this.method_12);
         ...
         this.createGroupsFromXmlList(_loc10_,this.var_269,param2,param3,param4,this._window,this.var_305);
         this.createGroupsFromXmlList(_loc11_,this.var_665,param2,param3,param4,this.var_230,this.var_305);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_168,this.var_542,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_168,this.var_542);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_168,this.var_542);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_930);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_230.x = this.var_168 + this.var_1983;
               this.var_230.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_230.x = 0;
               this.var_230.y = this.var_168 + this.var_1983;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1281;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_269.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1281 - this._toolbarMarginBottom) / (this.var_269.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1281 - this._toolbarMarginBottom) / (this.var_269.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function method_12(param1:WindowEvent) : void
      {
         if(this.var_1280)
         {
            this.var_1553 = true;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1280 && this.var_1553)
         {
            ...
            if(_loc2_ != null && _loc2_ != this.var_542)
            {
               ...
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_465);
                  _loc3_.orientation = this.var_542;
