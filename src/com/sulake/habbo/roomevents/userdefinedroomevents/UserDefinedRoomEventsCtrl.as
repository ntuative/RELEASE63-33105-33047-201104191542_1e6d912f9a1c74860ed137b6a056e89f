package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1437:int = 2;
      ...
      private var var_1789:TriggerConfs;
      
      private var var_1790:ActionTypes;
      ...
      private var var_141:UserDefinedRoomEventsHelp;
      
      private var var_1167:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1789 = new TriggerConfs();
         this.var_1790 = new ActionTypes();
         this.var_1788 = new ConditionTypes();
         this.var_258 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_770 = new RoomObjectHightLighter(param1);
         this.var_141 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_258[param1])
         {
            delete this.var_258[param1];
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1167 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_53,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1167.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1167.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_770.hideAll(this.var_258);
         }
      }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_80.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_38.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_38 as TriggerDefinition != null)
         {
            this.var_80.send(new UpdateTriggerMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ActionDefinition != null)
         {
            this.var_80.send(new UpdateActionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ConditionDefinition != null)
         {
            this.var_80.send(new UpdateConditionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1167.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1437) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1437 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_80.send(new ApplySnapshotMessageComposer(this.var_38.id));
      }
