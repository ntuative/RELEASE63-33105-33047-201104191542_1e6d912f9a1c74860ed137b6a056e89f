package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_356:String = "RCL_PUBLICROOM_";
      ...
      private static const const_442:String = "place_holder";
      
      private static const const_640:String = "wall_place_holder";
      
      private static const const_642:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_442;
      
      private static const const_641:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_984:String = "selection_arrow";
      ...
      {
         this.var_342 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_413 = new Dictionary();
         this.var_2241 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2238 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2239 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2242 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_900.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_489 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_489.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_342)
            {
               delete this.var_342[_loc1_];
            }
            this.var_342 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_720.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_414.add(_loc3_,_loc4_);
               if(this.var_342[_loc7_] == null)
               {
                  this.var_342[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_592.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2240)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_729));
            }
         }
      }
      ...
      {
         return [const_442,const_640,const_642,const_641,TILE_CURSOR,const_984];
      }
      ...
      {
         var _loc3_:String = this.var_592.getValue(param1) as String;
      ...
      {
         return this.var_900.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_899[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_592.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_720.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_199 != null && this.var_199.hasWorldType(const_356 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_275 || param1 == RoomObjectVisualizationEnum.const_70 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2242 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_342[_loc4_] == null)
                     {
                        this.var_342[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1379.getValue(param1) != null)
         {
            this.var_199 = this.var_1379.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_942,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2241.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1757);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_584,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_899.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1379.add(param1,_loc4_);
         this.var_199 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_719.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_719.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_719.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_356 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_356 + param1) == RoomObjectCategoryEnum.const_80)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_199.getWorldHeightScale(const_356 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_199 != null)
         {
            return this.var_199.getWorldScale(const_356 + param1);
         }
         return 32;
      }
