   ...
   public class TileHeightMap
   {
      ...
      public function TileHeightMap(param1:int, param2:int)
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_1050.push(_loc5_);
            this.var_1313.push(_loc6_);
            _loc3_++;
         }
         this.include = param1;
         this.var_172 = param2;
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.include && param2 >= 0 && param2 < this.var_172)
         {
      ...
      public function isRoomTile(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.include && param2 >= 0 && param2 < this.var_172)
         {
            _loc3_ = this.var_1313[param2] as Array;
            return Boolean(_loc3_[param1]);
         }
         return true;
      }
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.include && param2 >= 0 && param2 < this.var_172)
         {
            _loc4_ = this.var_1313[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param1 + param3 > this.include || param2 + param4 > this.var_172)
         {
            return false;
         }
         if(param5 < 0 || param5 >= this.include)
         {
            param5 = 0;
         }
         ...
         if(param5 + param7 >= this.include)
         {
            param7 = this.include - param5;
         }
         ...
         {
            _loc11_ = this.var_1050[_loc10_] as Array;
            _loc9_ = param1;
