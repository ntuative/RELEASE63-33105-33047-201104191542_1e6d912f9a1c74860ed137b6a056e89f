package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_581,RoomObjectMouseEvent.const_148];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1248,param1.toString(),true);
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_873,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1090)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1655;
            if(_loc2_ - this.var_1090 >= this.var_1654)
            {
               _loc3_ = this.var_1091;
               _loc4_ = this.var_1653;
               this.var_1090 = 0;
            }
            else
            {
               _loc7_ = this.var_1371 >> 16 & 255;
               _loc8_ = this.var_1371 >> 8 & 255;
               _loc9_ = this.var_1371 & 255;
               _loc10_ = this.var_1091 >> 16 & 255;
               _loc11_ = this.var_1091 >> 8 & 255;
               _loc12_ = this.var_1091 & 255;
               _loc13_ = (_loc2_ - this.var_1090) / this.var_1654;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1652 + (this.var_1653 - this.var_1652) * _loc13_;
               this._color = _loc3_;
               this.var_1655 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_681,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_944:
               param2.setString(RoomObjectVariableEnum.const_351,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_850:
               param2.setString(RoomObjectVariableEnum.const_319,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_680:
               param2.setString(RoomObjectVariableEnum.const_314,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_597:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_256)
               {
                  _loc5_ = "null";
               }
               this.var_488.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_859:
               _loc4_ = this.var_488.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_488.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1061,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1080:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1225:
               param2.setNumber(RoomObjectVariableEnum.const_830,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_873,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1371 = this._color;
         this.var_1652 = this.var_1655;
         this.var_1091 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_610,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1598,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1623,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1568,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_610,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_175 || _loc12_ == RoomPlaneData.const_294)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
