package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_501,RoomObjectFurnitureActionEvent.const_590,RoomObjectFurnitureActionEvent.const_528,RoomObjectFurnitureActionEvent.const_457,RoomObjectWidgetRequestEvent.const_157];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_413,RoomWidgetInfostandExtraParamEnum.const_751);
            ...
            if(_loc4_ != this.var_2247)
            {
               this.var_2247 = _loc4_;
               if(_loc4_ == 1)
               {
