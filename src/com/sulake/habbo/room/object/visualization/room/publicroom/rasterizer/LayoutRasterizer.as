package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_739:IGraphicAssetCollection;
      ...
      private var var_1516:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_996)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1516 = this.var_46.getValue(this.var_996);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2607 = new Vector3d(-0.5,0.5,0);
         this.var_995 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2607);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_996);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1907 = RoomObjectVariableEnum.const_1274;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1907 = RoomObjectVariableEnum.const_1179;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_996);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2608 && param3 == this.var_2609)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1907);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_498;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1516.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_739.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_439.indexOf(_loc10_) >= 0 && this.var_995)
            {
               param1 = this.var_439.indexOf(_loc10_);
               if(this.var_650[param1] != "")
               {
                  _loc9_ = this.var_739.getAsset(this.var_650[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      public function exchangeElementGraphics(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ < 0)
         {
            ...
            this.var_650.push(param2);
            this.var_651.push(-1);
         }
         else
         {
            this.var_650[_loc3_] = param2;
         }
      }
