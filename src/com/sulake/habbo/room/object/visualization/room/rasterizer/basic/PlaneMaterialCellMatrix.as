package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_851:int = 6;
      
      public static const const_1532:int = const_389;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_607);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_607,this.var_32.width,this.var_607);
         }
