package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1087)
            {
      ...
      {
         if(this.var_2190 == param1 && this.var_2189 == direction)
         {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1087.indexOf(_loc2_) < 0)
            {
               this.var_1087.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_482 == 0 || this.var_582 == 0)
         {
            ...
            this.var_482 = _loc2_.getNumber(RoomObjectVariableEnum.const_300);
            this.var_582 = _loc2_.getNumber(RoomObjectVariableEnum.const_409);
         }
         this.var_407 = [];
         this.var_583 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_482 * 2 + this.var_582 * 2)
         {
            this.var_407.push(false);
            this.var_583.push(ShoreMaskCreatorUtility.const_79);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_407,this.var_583,assetCollection);
      }
