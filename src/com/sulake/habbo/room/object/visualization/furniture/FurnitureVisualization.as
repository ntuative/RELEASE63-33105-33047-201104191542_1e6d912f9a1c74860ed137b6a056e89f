package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1797:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2305:Number = NaN;
      
      private var var_2303:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1122:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1396 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1396;
            this.var_1396 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1711)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2303);
               ...
               _loc4_.clickHandling = this.var_2301;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_466 != _loc3_.getUpdateID() || param1 != var_90 || param2 != this.var_2305)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2303 = _loc3_.getNumber(RoomObjectVariableEnum.const_283);
            ...
            this.var_1122 = this.getAdClickUrl(_loc3_);
            if(this.var_1122 == null || this.var_1122.indexOf("http") != 0)
            {
               this.var_1122 = null;
            }
            this.var_2301 = this.var_1122 != null;
      ...
      {
         if(this.var_2302 != param2 || this.var_2304 != param1)
         {
            this.var_907 = [];
            this.var_908 = [];
            this.var_737 = [];
            ...
            this.var_2306 = this.getSize(param1);
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_907[param2];
         var _loc4_:Boolean = this.var_908[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2306;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1711)
            {
      ...
      {
         if(this.var_734[param3] != null && !this.var_1710)
         {
      ...
      {
         if(this.var_732[param2] != null)
         {
            return this.var_732[param2];
         }
         if(this._data == null)
         {
