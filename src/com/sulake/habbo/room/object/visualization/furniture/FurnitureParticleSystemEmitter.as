package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1771:String = "cone";
      
      public static const const_1709:String = "plane";
      
      public static const const_1744:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_986 = 0;
         this.var_916 = false;
         this.init(0,0,0,this._direction,this.var_2580,this.var_987,this.var_2578,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1233.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_916 = true;
         if(this.var_986 < this.var_1507)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2579)
         {
            switch(this.var_2576)
            {
               case const_1771:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1233.length);
         return this.var_1233[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_986 < this.var_1507)
         {
            if(this.age % this.var_2577 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_986 < this.var_1507)
         {
            ...
            this.y = (2 - this.var_264) * this.y - (1 - this.var_264) * this.lastY + this.var_1891 * this.var_987 * this.var_987;
         ...
         for each(_loc2_ in this.var_370)
         {
            ...
            _loc2_.y = (2 - this.var_264) * _loc2_.y - (1 - this.var_264) * _loc2_.lastY + this.var_1891 * this.var_987 * this.var_987;
