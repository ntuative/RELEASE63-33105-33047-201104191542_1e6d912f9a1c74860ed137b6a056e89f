package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1886:String = "bg";
      ...
      private var var_2747:IContainerButtonWindow;
      ...
      {
         this.var_2744 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2745 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2747 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2746 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2744,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2745,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2747,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2746,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_146)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_146 && _loc4_.online)
            {
