package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1851:String = "no_reqs_info";
      ...
      private var var_1915:IContainerButtonWindow;
      ...
      {
         this.var_1915 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1916 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1916.procedure = this.onDismissAllButtonClick;
         this.var_1915.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1112)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_373 && _loc4_.state != FriendRequest.const_362)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1915,_loc1_);
         this.setEnabled(this.var_1916,_loc1_);
      }
