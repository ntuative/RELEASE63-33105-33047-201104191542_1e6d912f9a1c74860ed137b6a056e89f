package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_859:ITextFieldWindow;
      ...
      {
         this.var_859 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_859.procedure = this.onSearchInput;
         this.var_859.addEventListener(WindowKeyboardEvent.const_176,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_61.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_337,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_859.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_859.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_859.text;
