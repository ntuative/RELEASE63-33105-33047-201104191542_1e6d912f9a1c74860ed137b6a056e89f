package com.sulake.habbo.friendbar
{
   ...
   public class HabboFriendBar extends ComponentContext
   {
      ...
      private function onConfigurationAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1132 = this.var_195.getKey("friend_bar.helper.friend_finding.enabled") == "true";
         var _loc4_:* = this.var_195.getKey("client.toolbar.static.enabled","RoomWidgetDimmerUpdateEvent") == "true";
         if(_loc3_)
         {
