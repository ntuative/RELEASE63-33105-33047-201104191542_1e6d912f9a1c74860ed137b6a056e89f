package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_745:String = "issue_bundle_my";
      
      public static const const_1075:String = "issue_bundle_picked";
      
      public static const const_1659:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_589 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1098 = [];
         this.var_1097 = [];
         this.var_896 = new Map();
         this.var_2217 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1671 = new Timer(const_1659,0);
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1098 = this.var_1098.concat(_loc4_.getIssueIds());
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1129);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1665)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1098.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_745);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1097.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2217);
            }
         }
