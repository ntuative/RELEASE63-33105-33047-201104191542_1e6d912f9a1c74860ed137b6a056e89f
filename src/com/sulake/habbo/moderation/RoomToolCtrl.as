package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_992:ICheckBoxWindow;
      
      private var var_1510:ICheckBoxWindow;
      
      private var var_1511:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_353));
         Logger.log("BEGINNING TO SHOW: " + this.var_353);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_353);
         if(param1.flatId != this.var_353)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_353);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_992 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1510 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1511 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_884,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_992.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1787,_loc2_,this.var_517.text,"",""));
         if(this.var_1510.isSelected || this.var_1511.isSelected || this.var_992.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1510.isSelected,this.var_1511.isSelected,this.var_992.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1511);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1795);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1147.selection];
         if(_loc3_ != null)
         {
            this.var_591 = false;
