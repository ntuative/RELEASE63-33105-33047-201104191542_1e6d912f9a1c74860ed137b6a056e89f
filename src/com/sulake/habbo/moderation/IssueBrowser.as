package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2140:String = "my_issues";
      
      private const const_2141:String = "open_issues";
      
      private const const_2142:String = "picked_issues";
      
      private const const_2145:String = "closed_issues";
      ...
      private var var_2074:IIssueBrowserView;
      
      private var var_2076:IIssueBrowserView;
      
      private var var_2075:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_281 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_281.numTabItems)
            {
               _loc5_ = this.var_281.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_281 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_281 == null || this.var_281.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_281.selector.getSelectableByName("open_issues");
         this.var_281.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_393.view.width = this.var_281.container.width;
         this.var_393.view.height = this.var_281.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2140:
               ...
               {
                  this.var_2074 = new MyIssuesView(this.issueManager,this,this.var_281.container);
               }
               return this.var_2074;
            case this.const_2141:
               if(this.var_2076 == null)
               {
                  this.var_2076 = new OpenIssuesView(this.issueManager,this,this.var_281.container);
               }
               return this.var_2076;
            case this.const_2142:
               if(this.var_2075 == null)
               {
                  this.var_2075 = new PickedIssuesView(this.issueManager,this,this.var_281.container);
               }
