package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1544:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_659 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_659.width;
         this.var_98 = this.var_659.height;
         this.var_1266 = param5;
         this.var_1015 = param6;
         this.var_229 = Math.floor(this.var_1266 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1266,this.var_1015);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_660 = this.resolveRowCountFromList();
         if(this.var_660 == 0)
         {
            this.var_26 = new BitmapData(this.var_1266,this.var_1015);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_229 * this._thumbWidth,this.var_1266),Math.max(this.var_660 * this.var_98,this.var_1015),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_660)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_229)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_26.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_98),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_229 && this.var_26.height < _loc3_.y * this.var_98)
         {
            _loc2_ = new BitmapData(this.var_26.width,this.var_26.height + this.var_98);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_229 - 1),this.var_98);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_229 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_98),null,null,true);
         _loc4_ = new Rectangle(0,this.var_98,this._thumbWidth * (this.var_229 - 1),this.var_26.height - this.var_98);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,this.var_98),null,null,true);
         this.var_26 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1544.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < this.var_660 - 1)
         {
            _loc7_ = this.var_26.width - this._thumbWidth;
            _loc8_ = this.var_26.height - (param1.y + 1) * this.var_98;
            ...
            this.var_26.fillRect(new Rectangle(0,this.var_26.height - this.var_98,this.var_26.width,this.var_98),4294967295);
            _loc3_ = new Point(this.var_26.width - this._thumbWidth,_loc2_.y - this.var_98);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(this.var_26.width,this.var_26.height - this.var_98);
               _loc2_ = new Rectangle(0,0,this.var_26.width,this.var_26.height - this.var_98);
               _loc11_.copyPixels(this.var_26,_loc2_,new Point(0,0),null,null,true);
               this.var_26 = _loc11_;
               --this.var_660;
            }
         }
         if(this.var_26.height < this.var_1015)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1015);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_659.width,this.var_659.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_659.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_659,this.var_659.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
