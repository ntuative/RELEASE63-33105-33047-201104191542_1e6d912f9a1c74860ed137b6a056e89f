package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2902:BitmapData;
      
      private const const_2082:int = 8947848;
      
      private const const_2083:int = 13421772;
      
      private const const_1819:Number = 1;
      
      private const const_1818:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2901 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1593));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_792)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1818;
               _loc1_.blend = this.const_1818;
            }
            else
            {
               this._window.blend = this.const_1819;
               _loc1_.blend = this.const_1819;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2124 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2902;
               _loc5_.visible = true;
            }
            else
            {
