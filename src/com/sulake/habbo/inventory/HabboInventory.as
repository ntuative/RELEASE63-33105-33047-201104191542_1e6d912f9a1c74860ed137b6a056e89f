package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2095:int = 500;
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_54.getValue(InventoryCategory.const_82));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_54.getValue(InventorySubCategory.const_304));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_54.getValue(InventoryCategory.const_833));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_54.getValue(InventoryCategory.const_329));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_54.getValue(InventoryCategory.const_395));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_54.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_54.getValue(InventoryCategory.const_139));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_54.getValue(InventoryCategory.const_399) as MarketplaceModel;
      }
      ...
      private function initInventory() : void
      {
         ...
         this.var_54.add(InventoryCategory.const_399,_loc1_);
         ...
         this.var_54.add(InventoryCategory.const_833,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_417);
         this.var_54.add(InventoryCategory.const_395,_loc5_);
         ...
         this.var_54.add(InventorySubCategory.const_304,_loc6_);
         ...
         this.var_54.add(InventorySubCategory.RECYCLER,_loc7_);
         ...
         this.var_54.add(InventoryCategory.const_139,_loc8_);
         this.var_196 = true;
         if(this.var_2420)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_940.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_940.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_940.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_940.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2095);
         }
      }
