package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      public static const const_1085:int = 1;
      ...
      private var var_1012:GroupItem;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1046) : uint(const_1047);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1046) : uint(const_1047);
            }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            this.method_2(this.var_18.ownUserId);
         }
         ...
         if(_loc6_)
         {
            this.method_2(this.var_18.otherUserId);
         }
      }
      ...
      public function removeSelection() : void
      {
         if(this.var_1012)
         {
            this.var_1012.isSelected = false;
            this.var_1012 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1794)
            {
            ...
            this.var_657.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_604);
            this.var_657.show();
         }
         ...
         if(this.var_189.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_657.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_604);
               }
            }
            else
            {
