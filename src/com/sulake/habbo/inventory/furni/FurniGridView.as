   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_69.toggleItemSelection(this._category,this.var_253.getGridItemIndex(param1.window));
            this.var_590 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_590 != null && this.var_590 == param2 && !this.var_69.isTradingOpen)
         {
