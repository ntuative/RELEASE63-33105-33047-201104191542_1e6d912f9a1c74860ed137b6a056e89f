package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1853:int = 42;
      
      private const const_1855:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_442.add(FurniModel.const_46,new FurniGridView(this.var_69,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_442.add(FurniModel.const_50,new FurniGridView(this.var_69,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function setViewToState() : void
      {
         ...
         {
            _loc2_ = this.const_1852;
         }
         else
         {
            _loc2_ = this.const_1854;
         }
         if(this.var_2247 == _loc2_)
         {
            return;
         }
         this.var_2247 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_319);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_351);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_314);
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1220)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1855)
         {
            _loc3_ = this.const_1855;
         }
         else if(_loc3_ < this.const_1853)
         {
            _loc3_ = this.const_1853;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_435);
            }
         }
      }
