package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_435:String = "pets";
      
      private static const const_1433:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_632 = new Timer(const_1433,1);
         ...
         this.var_2486 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_962 == null)
         {
            this.var_962 = this._windowManager.buildFromXML(this.var_2486) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_962.clone() as IWindowContainer;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_631.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      {
         this.method_7(param1,param2);
      }
      
      public function method_7(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc7_:* = null;
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_311 || _loc3_.category == FurniCategory.const_307 || _loc3_.category == FurniCategory.const_296)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_792)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
