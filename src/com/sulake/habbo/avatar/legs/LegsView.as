   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_282,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_247,_windowManager,_assetLibrary);
         }
         else
         {
