package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_972:AvatarActionManager;
      ...
      private var var_1036:ActionDefinition;
      
      private var var_512:String;
      
      private var var_1490:PartOffsetData;
      ...
      {
         this.var_1490.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_512);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_512);
            return;
         }
         this.var_972 = new AvatarActionManager(param1,this.var_512,param2);
         this.var_1036 = this.var_972.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_512);
            return false;
         }
         if(this.var_433.parse(param1))
         {
            if(this.var_512 == AvatarType.const_126)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_512);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_512);
            return false;
         }
      ...
      {
         return this.var_972.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_972.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_972.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_640[param1][param2] = this.var_365.getMandatorySetTypeIds(param1,param2);
         return this.var_640[param1][param2];
      }
      ...
      {
         return this.var_972.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return this.var_1490.getOffset(param1,param2,param3,param4,param5,param6);
      }
