package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2626 = parseInt(param1.@pattern);
         this.var_943 = String(param1.@gender);
         this.var_1353 = Boolean(parseInt(param1.@colorable));
         this.var_2624 = String(param1.@localizationKey);
