package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1323:IWindowContainer;
      
      public static var var_1605:IWindowContainer;
      
      public static var var_2113:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1255 = [];
         this.var_1474 = [AvatarEditorFigureCategory.const_832,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_235,AvatarEditorFigureCategory.const_723,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_106];
         super();
         ...
         if(var_1323 == null)
         {
            ...
            var_1323 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1605 == null)
         {
         ...
         if(param4 == null)
         {
            param4 = this.var_1474;
         }
         for each(_loc6_ in param4)
         {
            this.var_1255.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1474);
         }
         if(param1.length != this.var_1255.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1255.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2668 = this.canChangeOutfit();
            this.var_444.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1255.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1474;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1927 == AvatarEditorSideCategory.const_106 || this.var_2669))
         {
      ...
      {
         if(this.var_1927 == AvatarEditorSideCategory.const_106)
         {
            this.var_2669 = false;
            this.setSideContent(AvatarEditorSideCategory.const_770);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_770:
               break;
            case AvatarEditorSideCategory.const_523:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_523);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2232 = new Date().valueOf();
                  this.var_2668 = false;
                  this.var_444.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2232 > 5000;
      }
   }
}
