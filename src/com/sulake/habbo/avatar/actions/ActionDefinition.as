package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2262 = parseInt(param1.@precedence);
         this.var_2260 = String(param1.@activepartset);
         this.var_2265 = String(param1.@assetpartdefinition);
         this.var_2263 = String(param1.@lay);
         this.var_712 = String(param1.@geometrytype);
         this.var_2259 = Boolean(parseInt(param1.@main));
         this.var_2264 = Boolean(parseInt(param1.@method_1));
         this.var_2261 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_727.add(param1,new Map());
         }
         var _loc4_:Map = this.var_727.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_727.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1699[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2258;
         }
         return _loc2_;
      }
