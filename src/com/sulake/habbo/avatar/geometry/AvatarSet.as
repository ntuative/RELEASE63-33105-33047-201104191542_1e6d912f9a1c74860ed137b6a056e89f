package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2259 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         ...
         {
            this.var_1941.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1941.concat();
         for each(_loc3_ in this.var_1261)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2687 = _loc6_;
      }
