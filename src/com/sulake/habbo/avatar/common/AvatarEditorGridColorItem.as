package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_1029 = _loc5_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1029.width,this.var_1029.height,true,0);
            _loc5_ = this.var_1029.clone();
            ...
            if(this.var_915)
            {
               switch(this.var_915.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_44:
                     _loc4_.style = HabboIconType.const_905;
                     _loc4_.visible = true;
                     break;
