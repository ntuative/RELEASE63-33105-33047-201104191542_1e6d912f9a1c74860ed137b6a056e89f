package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_1377:IWindow;
      
      private var var_857:IFigurePartSet;
      ...
      private const const_2082:int = 13421772;
      
      private const const_2083:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_857 = param3;
         this._window = param1;
         this.var_1377 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_2071 = Math.max(this.var_2071,_loc6_.colorLayerIndex);
            }
         }
         this.var_459 = this.var_69.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_693 != null && !this.var_2072)
            {
               _loc3_ = this.var_693;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1377.color = this.const_2082;
         }
         else
         {
            this.var_1377.color = this.const_2083;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_459.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_459.isFigureReady(_loc1_))
         {
            this.var_459.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_361[_loc6_] + "_" + FigureData.const_144;
               _loc4_ = this.var_459.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_688 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_2070)
               {
                  ...
                  this.var_2070 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_688.width,this.var_688.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_688.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_688.y;
