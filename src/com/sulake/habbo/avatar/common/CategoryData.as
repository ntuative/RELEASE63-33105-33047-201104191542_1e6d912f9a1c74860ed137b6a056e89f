package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2144:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1046 >= 0 && this._parts.length > this.var_1046)
         {
            _loc2_ = this._parts[this.var_1046];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_1046] as AvatarEditorGridPartItem;
      }
