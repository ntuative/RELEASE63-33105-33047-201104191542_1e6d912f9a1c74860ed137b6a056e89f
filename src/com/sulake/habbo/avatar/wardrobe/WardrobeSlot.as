package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_622 && this.var_1455)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_92,this.var_943,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_805));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1455 && this.var_622 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_622 = this._controller.figureData.getFigureString();
               this.var_943 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1809,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_622)
               {
                  this._controller.loadAvatarInEditor(this.var_622,this.var_943,this._controller.clubMemberLevel);
               }
         }
      }
