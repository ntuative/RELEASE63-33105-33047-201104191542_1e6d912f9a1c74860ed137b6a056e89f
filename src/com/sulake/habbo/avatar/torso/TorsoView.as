   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_240,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_189,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_258,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_151 == "")
         {
            var_69.switchCategory(FigureData.const_189);
         }
      }
