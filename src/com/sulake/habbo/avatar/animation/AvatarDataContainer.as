package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1986:Number = 1.0;
      ...
      {
         super();
         this.var_2078 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2887 = parseInt(_loc2_,16);
         this.var_2889 = parseInt(_loc3_,16);
         ...
         this.var_849 = new ColorTransform(this.var_1984,this.var_1985,this.var_1986,this._alphaMultiplier);
         this.var_1318 = this.generatePaletteMapForGrayscale(this.var_2889,this.var_2887);
      }
      ...
      {
         return this.var_1318.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1318.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1318.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1318.getValue("alphas") as Array;
      }
