package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1447:String = "room_view";
      
      private const const_2131:String = "room_widget";
      
      private var var_51:IWindowContainer;
      
      private var var_810:int = 50;
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2131) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_51.getChildByTag(this.const_1447) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_810;
               _loc2_.width = this.var_51.desktop.width - this.var_810;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_810;
               _loc2_.height = this.var_51.desktop.height - this.var_810;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_51.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_51.findChildByTag(this.const_1447) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
