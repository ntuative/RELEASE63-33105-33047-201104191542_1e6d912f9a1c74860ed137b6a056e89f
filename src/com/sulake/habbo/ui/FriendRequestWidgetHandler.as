package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_684);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_739);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_767);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_684:
            ...
            case RoomWidgetFriendRequestMessage.const_739:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_767:
