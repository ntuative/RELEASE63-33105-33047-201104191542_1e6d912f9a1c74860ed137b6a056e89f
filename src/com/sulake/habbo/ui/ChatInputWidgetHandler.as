package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_945);
         _loc1_.push(RoomWidgetChatTypingMessage.const_823);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_945:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_823:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1189,HabboToolbarIconEnum.CHATINPUT,param1));
      }
