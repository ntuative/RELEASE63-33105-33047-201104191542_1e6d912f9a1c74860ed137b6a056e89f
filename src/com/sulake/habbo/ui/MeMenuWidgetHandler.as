package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_916,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_521,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_916,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_521,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1549)
            {
               ...
               this.var_1961 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1961;
            }
         }
         if(this._toolbar != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1270,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_901);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_839);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_769);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_858);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_397);
         _loc1_.push(RoomWidgetStopEffectMessage.const_678);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1692);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1106);
         _loc1_.push(RoomWidgetToolbarMessage.const_730);
         _loc1_.push(RoomWidgetToolbarMessage.const_911);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_410);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1716);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1084);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_677);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_831);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_952);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1752);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_812);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_869);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_696);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_831:
               ...
               break;
            case RoomWidgetWaveMessage.const_901:
            ...
            case RoomWidgetSelectEffectMessage.const_755:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_839:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_397:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1227)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_858:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_769:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1106:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_677:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_730:
               ...
               break;
            case RoomWidgetToolbarMessage.const_911:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_574,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_410:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_582));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_952:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_401,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_812:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_401,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_869:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_401,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_696:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_521:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_476));
         }
      }
