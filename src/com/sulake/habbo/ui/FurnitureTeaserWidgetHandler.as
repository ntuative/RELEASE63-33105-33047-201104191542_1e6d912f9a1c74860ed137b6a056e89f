package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_747,RoomWidgetViralFurniMessage.const_877,RoomWidgetViralFurniMessage.const_164];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_747:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_506);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_877:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_579,RoomSessionViralFurniStatusEvent.const_548];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_579:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_878);
