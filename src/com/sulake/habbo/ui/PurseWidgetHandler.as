      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_817:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_107,_loc2_.getActivityPointsForType(Purse.const_210)));
               break;
            case RoomWidgetOpenCatalogMessage.const_397:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1086:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1679);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1202:
