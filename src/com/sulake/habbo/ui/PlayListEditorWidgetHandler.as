package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1359:IMessageEvent;
      
      private var var_1644:IMessageEvent;
      
      private var var_1643:IMessageEvent;
      ...
      {
         this.var_1359 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1644 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1643 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1359);
         this._connection.addMessageEvent(this.var_1644);
         this._connection.addMessageEvent(this.var_1643);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1359);
         this._connection.removeMessageEvent(this.var_1644);
         this._connection.removeMessageEvent(this.var_1643);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_793,RoomWidgetPlayListModificationMessage.const_960,RoomWidgetPlayListModificationMessage.const_733,RoomWidgetPlayListPlayStateMessage.const_736,RoomWidgetPlayListUserActionMessage.const_886];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_793:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_960:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_733:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_736:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_886:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_260);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_260:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_867,_loc2_.objectId);
