package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetChatMessage.const_466,RoomWidgetChatSelectAvatarMessage.const_855];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_466:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1107))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1107))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_855:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1226 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1226);
            }
            if(this.var_806 == null)
            {
               ...
               this.var_516.y = 0;
               this.var_516.z = 0;
               this.var_806 = _loc4_.getScreenPoint(this.var_516);
               this.var_1226 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_516.x = 0;
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1885.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1885.remove(param1);
         if(_loc3_ != null)
         {
