package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_375:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_375 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_375.procedure = null;
         this.var_375.populate(_loc1_);
         this.var_375.selection = 0;
         this.var_375.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_375 == null ? 0 : int(this.var_375.selection);
         ...
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_266,Tabs.const_864);
         }
         else
         {
