package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1476:int = 4;
      ...
      private var var_1025:GuestRoomListCtrl;
      
      private var var_1283:OfficialRoomListCtrl;
      
      private var var_281:ITabContextWindow;
      ...
      private var var_1558:IWindow;
      
      private var var_1285:IRegionWindow;
      ...
      private const const_982:Point = new Point(100,10);
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1025 = new GuestRoomListCtrl(this._navigator);
      ...
      public function open() : void
      {
         ...
         {
            this.prepare();
            this.var_15.position = this.const_982;
            _loc1_ = true;
         }
         this.refresh();
      ...
      private function prepare() : void
      {
         ...
         this.var_281 = ITabContextWindow(this.var_15.findChildByName("tab_context"));
         if(!this.var_281)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_179 = IWindowContainer(this.var_15.findChildByName("tab_content"));
         this.var_231 = IWindowContainer(this.var_15.findChildByName("custom_content"));
         this.var_213 = IWindowContainer(this.var_15.findChildByName("list_content"));
         this.var_270 = IWindowContainer(this.var_15.findChildByName("custom_footer"));
         this.var_1558 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1285 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1285)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1285.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_15.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_281.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1508,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_179,["custom_content","list_content"],this.var_231.y,8);
         this.var_213.height = this.var_213.height + _loc1_ - this.var_213.y - this.var_270.height + this.var_2752;
         Util.moveChildrenToColumn(this.var_179,["list_content","custom_footer"],this.var_213.y,0);
         this.var_2752 = this.var_270.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_281.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1987 = true;
            this.var_281.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1025,"guest_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_666 == const_1050)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_213.blend - _loc2_));
            this.var_213.blend = _loc3_;
            this.var_231.blend = !!this.var_1284 ? Number(_loc3_) : Number(1);
            this.var_270.blend = !!this.var_1284 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_666 = const_669;
            }
         }
         else if(this.var_666 == const_669)
         {
            if(this.var_1557 % 10 == 1)
            {
               this.var_1558.visible = !this.var_1558.visible;
            }
            ++this.var_1557;
            if(!this._navigator.data.isLoading())
            {
               this.var_666 = const_1051;
            }
         }
         else if(this.var_666 == const_1051)
         {
            this.refresh();
            this.var_666 = const_1476;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_1025);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1285,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1285,"icon_hotelview_reactive",param1,null,0);
      }
