package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1888 = this._navigator.getButtonImage(this.var_1890);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1887 == null)
         {
            ...
            this.var_1887 = new Rectangle(this.var_1503,this.var_1503,_loc1_.width - 2 * this.var_1503,_loc1_.height - 2 * this.var_1503);
         }
         this.var_648.bitmap.fillRect(this.var_648.bitmap.rect,4281545523);
         this.var_648.bitmap.fillRect(this.var_1887,4284900966);
         this.copyTo(this.var_648.bitmap);
         if(this._selected)
         {
            this.var_648.bitmap.copyPixels(this.var_1889,this.var_1889.rect,new Point(0,0),null,null,true);
         }
