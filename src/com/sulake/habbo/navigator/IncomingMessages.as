package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1242)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1588)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            {
               this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.ROOMINFO));
            }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         else if(_loc2_.roomForward)
         {
            ...
            else if(_loc2_.data.doorMode == RoomSettingsData.const_129 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1648:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1551:
