package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_464:RoomInfoViewCtrl;
      
      private var var_1315:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_458:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2985:Dictionary;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_464 = new RoomInfoViewCtrl(this);
         this.var_1315 = new RoomCreateViewCtrl(this);
         this.var_2748 = new RoomThumbnailRenderer(this);
         this.var_930 = new GuestRoomPasswordInput(this);
         this.var_312 = new GuestRoomDoorbell(this);
         this.var_458 = new Tabs(this);
         this.var_1316 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_342,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1445 = new IncomingMessages(this);
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_464.registerToolbarEvents();
      }
      ...
      public function openCatalogClubPage() : void
      {
         ...
         this._catalog.openCatalogPage(CatalogPageName.const_211,true);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_464.handleToolbarEvent(param1);
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_326.startSearch(Tabs.const_250,Tabs.const_434,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_326.startSearch(Tabs.const_315,Tabs.const_269);
         this.var_458.getTab(Tabs.const_315).tabPageDecorator.tabSelected();
      }
