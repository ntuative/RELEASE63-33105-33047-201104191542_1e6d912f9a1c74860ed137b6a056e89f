package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_126:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2748 = new RoomThumbnailRenderer(param1);
         this.var_1311 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_191,this.var_126);
         if(this.var_126.ownerName != "" && this.var_126.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_191,!!this.var_126.event ? this.getEventCtg(this.var_126.categoryId) : this.getRoomCtg(this.var_126.categoryId));
         this.refreshRoomDesc(this.var_191,this.var_126);
         this.refreshExtraCont();
         this.refreshInfo(this.var_191,"trading_allowed",this.var_126.allowTrading);
         this.refreshInfo(this.var_191,"doormode_doorbell",this.var_126.doorMode == 1);
         this.refreshInfo(this.var_191,"doormode_password",this.var_126.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_191,this.var_126.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1311.refreshTags(_loc1_,this.var_126.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_126.score);
         if(this.var_126.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_126.eventCreationTime);
         }
         this.var_2748.refreshThumbnail(_loc1_,this.var_126.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_226,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
