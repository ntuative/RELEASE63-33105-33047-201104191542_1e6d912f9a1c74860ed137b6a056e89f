package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1839:int = 10;
      ...
      private var var_629:RoomEventData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_957 = param1.publicSpace;
            this.var_629 = null;
         }
      }
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1473 = new Array();
         for each(_loc2_ in this.var_1474)
         {
            if(_loc2_.visible)
            {
      ...
      public function onFavourites(param1:FavouritesMessageParser) : void
      {
         ...
         this.var_1472 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1472 >= this.var_2477;
      }
