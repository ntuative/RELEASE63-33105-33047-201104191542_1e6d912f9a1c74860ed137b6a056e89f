package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1095:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_588 = new Timer(100);
         this.var_588.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_588)
         {
            this.var_588.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_588.reset();
            this.var_588 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1095.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1667 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1667 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_61 = IItemListWindow(this.var_179.findChildByName("item_list"));
         ...
         this.var_1096 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_179.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function refresh() : void
      {
         ...
         this.var_1096.input.textBackgroundColor = 4294967295;
         this.var_1095 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_68,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1096.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1096.getText();
         var _loc3_:String = "model_" + this.var_1095.name;
