package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      {
         this.var_353 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_353));
         if(this.var_1158 != null)
         {
            this.var_1158.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_353)
         {
            return;
         }
         this.var_76 = param1;
      ...
      {
         if(param1 != this.var_353 || this.var_1161 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1161 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1549)
         {
            this.var_764.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1777)
         {
         ...
         {
            this.setTagError(this.var_902,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_901,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1615)
         {
            this.setTagError(this.var_902,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_901,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1600)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_592,this.onDoorModePasswordUnselect);
         ...
         this.var_1162 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_902 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_901 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_930 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1154 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1157 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1160 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1155 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_615 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1156 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1159 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1774 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1158 = IWindowContainer(this._window.findChildByName("password_container"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1774.visible = this._inRoom;
         if(this.var_765)
         {
            this.var_1159.visible = true;
            this.var_1429.visible = false;
            this.refreshFlatControllers();
            this.var_1159.height = Util.getLowestPoint(this.var_1159) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1156.visible = true;
            this.var_1429.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1156.height = Util.getLowestPoint(this.var_1156) + 4;
         }
         this.var_1430.text = !!this.var_765 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1156.name,this.var_1159.name,this.var_1429.name,this.var_1774.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1162.setText(_loc1_.description);
         this.var_930.setText("");
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_129);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_902,_loc1_.tags[0]);
         this.setTag(this.var_901,_loc1_.tags[1]);
         if(this.var_1157)
         {
            if(_loc1_.allowPets)
            {
               this.var_1157.select();
            }
            else
            {
               this.var_1157.unselect();
            }
         }
         if(this.var_1160)
         {
         ...
         if(this.var_1155)
         {
            ...
            {
               this.var_1155.select();
            }
            else
            {
               this.var_1155.unselect();
            }
         }
         if(this.var_615)
         {
            ...
            {
               this.var_615.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_615.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1162.getText();
         ...
         _loc2_.allowPets = this.var_1157.isSelected;
         _loc2_.allowFoodConsume = this.var_1160.isSelected;
         _loc2_.allowWalkThrough = this.var_1155.isSelected;
         _loc2_.hideWalls = this.var_615.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_902,_loc2_.tags);
         this.addTag(this.var_901,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_353);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_76.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_353]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_167,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_68,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_353));
      }
