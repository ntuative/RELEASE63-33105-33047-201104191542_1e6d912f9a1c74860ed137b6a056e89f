package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1617) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1080.width,this.var_1080.height,true,0);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1617 = XML(_loc2_.content);
         ...
         this.var_1080 = BitmapData(_loc3_.content);
