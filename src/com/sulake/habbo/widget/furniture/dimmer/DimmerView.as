package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_445:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_68,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1389,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_445 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_281 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_281.numTabItems)
         {
            _loc6_ = this.var_281.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1541 = _loc2_.light;
         if(this.var_445 != null)
         {
            this.var_445.setValue(this.var_1541);
         }
         this.var_521 = this.colors.indexOf(_loc2_.color);
         if(this.var_656 != null)
         {
            this.var_656.setSelectedColorIndex(this.var_521);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_281.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_281.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_281.selector.getSelected();
         return this.var_281.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1540 = XML(_loc1_.content);
         return this.var_1540;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_445 != null)
         {
            this.var_445.min = this._widget.minLights[param1 - 1];
         }
      }
