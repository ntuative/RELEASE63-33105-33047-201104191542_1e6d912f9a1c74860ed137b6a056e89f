package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1043:String = "welcome_gift_email_verified";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1250)
         {
            this.setViewState(this.const_1043);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_664:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1000;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1000);
               break;
            ...
            case this.const_1455:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1000);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1525;
               _loc6_.focus();
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_799,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1250 ? this.const_1043 : this.const_664);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1526 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1526));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_766,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_766,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_569:
               this.var_1525 = param1.email;
               this.var_1250 = param1.isVerified;
               this.var_1000 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1525 = this.var_1526;
            this.setViewState(this.const_664);
         }
         else
         {
            if(param1.result == this.const_2133)
            {
               this.var_1000 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1526);
