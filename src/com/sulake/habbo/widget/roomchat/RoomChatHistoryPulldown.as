package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1044:int = 150;
      ...
      private var var_2681:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2681 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1937 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2684 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1935 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1936 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2685 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2686 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_78 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_342,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_78);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_68,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_478,HabboWindowStyle.const_45,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_461:
               this.var_78.blend += param1 / const_1045;
               ...
               break;
            case const_966:
               this.var_78.blend -= param1 / const_1044;
               this._window.blend -= param1 / const_1044;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_42.height - const_83;
            this._window.width = this.var_42.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_42.height - const_83;
            this._region.width = this.var_42.width - this.var_2682;
         }
         if(this.var_78 != null)
         {
            this.var_78.rectangle = this.var_42.rectangle;
            this.var_78.height -= const_83;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2683 == this._window.width)
         {
            return;
         }
         this.var_2683 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2684;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1935;
            _loc2_.disposesBitmap = false;
            this.var_2682 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2681,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1937,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1937,_loc9_);
         ...
         this.var_78.bitmap = this.var_2686;
