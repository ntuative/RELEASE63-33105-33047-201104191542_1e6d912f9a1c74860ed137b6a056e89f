package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_621:ChooserView;
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_621 == null)
         {
            this.var_621 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         this.var_621.populate(param1.items,param1.isAnyRoomController);
      }
