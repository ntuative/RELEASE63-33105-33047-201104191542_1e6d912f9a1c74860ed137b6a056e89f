package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2094:int = 1000;
      ...
      {
         super();
         this.var_210 = new Timer(this.const_2094);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_182.isActive)
         {
            ...
            this.var_935.width = _loc2_ * this.var_304;
         }
         else
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_936 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_935 != null)
         {
            this.var_304 = this.var_935.width;
            this.var_210.start();
            this.onUpdate();
         }
