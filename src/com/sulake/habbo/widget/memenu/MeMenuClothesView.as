package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_696));
         }
         this._widget = null;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this._widget.config.getKey("client.toolbar.static.enabled","RoomWidgetDimmerUpdateEvent") == "true")
         {
            this._widget.mainContainer.position = DEFAULT_LOCATION;
         }
         this._window.addEventListener(WindowEvent.const_134,this.onChildResized);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_410,this._window));
      }
