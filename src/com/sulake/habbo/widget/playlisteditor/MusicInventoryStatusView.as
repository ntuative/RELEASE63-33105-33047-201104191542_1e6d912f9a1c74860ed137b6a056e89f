package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_406.add(const_893,_loc1_);
            this.var_1754 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1753 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_406.add(const_811,_loc1_);
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_406[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
