package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_73.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_73.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_73.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_73.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_102.playButtonState = MusicInventoryGridItem.const_1071;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_102 != null)
         {
            this.var_102.playButtonState = MusicInventoryGridItem.const_516;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_146;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_102.playButtonState == MusicInventoryGridItem.const_516)
               {
                  this.var_102.playButtonState = MusicInventoryGridItem.const_1161;
