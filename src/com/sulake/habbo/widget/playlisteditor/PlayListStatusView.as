package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_856:String = "PLSV_ADD_SONGS";
      
      public static const const_1290:String = "PLSV_START_PLAYBACK";
      
      public static const const_470:String = "PLSV_NOW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_406.getValues())
         {
            _loc1_.destroy();
         }
         this.var_406 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_406[param1] as IWindowContainer,0);
         this.var_47 = param1;
      }
      
      public function set nowPlayingTrackName(param1:String) : void
      {
         if(this.var_47 != const_470)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_406[this.var_47];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_406[const_856];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_406.add(const_470,_loc1_);
