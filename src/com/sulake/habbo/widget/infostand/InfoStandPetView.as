package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2128:int = 152;
      
      private const const_2118:int = 16;
      
      private const const_1442:int = 4;
      
      private const const_2129:uint = 14342874;
      
      private const const_2119:uint = 3815994;
      
      private const const_2123:uint = 2085362;
      
      private const const_2130:uint = 39616;
      
      private const const_2121:uint = 10513106;
      
      private const const_2125:uint = 8734654;
      
      private const const_2127:uint = 9094430;
      
      private const const_2120:uint = 6200576;
      
      private const const_2126:String = "happiness";
      
      private const const_2122:String = "experience";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2126,param1.nutrition,param1.nutritionMax,this.const_2130,this.const_2123);
         this.updateStateElement(this.const_2122,param1.experience,param1.experienceMax,this.const_2125,this.const_2121);
         this.updateStateElement(this.const_2124,param1.energy,param1.energyMax,this.const_2120,this.const_2127);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2128,this.const_2118,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2129);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2119);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1442,_loc7_.width - 2,_loc7_.height - 2 - this.const_1442);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1442);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_207 && this.var_207.getPetId() == this.var_539)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1538,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_379,this._widget.petData.ownerId);
