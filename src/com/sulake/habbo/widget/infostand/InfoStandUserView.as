package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1311:TagListRenderer;
      
      private var var_137:IBorderWindow;
      
      private var var_2538:int;
      
      private const const_1031:int = 5;
      
      private const const_1841:int = 7829367;
      
      private const const_1842:int = 16777215;
      
      private const const_2108:int = 2000;
      
      private const const_2107:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1311 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_55 == null || this.var_48 == null || this.var_103 == null)
         {
            return;
         }
         this.var_55.height = this.var_55.scrollableRegion.height;
         this.var_48.height = this.var_55.height + 20;
         this._window.width = Math.max(this.var_48.width,this.var_103.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_48.width < this.var_103.width)
         {
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1031;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1841;
            }
            else
            {
               _loc3_.textColor = this.const_1842;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1031,this.const_2107);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_317,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_317,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1311.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2538 > this.const_2108 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2538 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1841;
         }
      }
