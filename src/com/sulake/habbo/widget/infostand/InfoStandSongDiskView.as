package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1928 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_372 && param1.songId == this.var_1928)
         {
            this.trackName = param1.songName;
            this.authorName = param1.method_8;
         }
      }
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_238 = var_48.findChildByTag("catalog");
         if(var_238 != null)
         {
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_405.length,param1.length);
