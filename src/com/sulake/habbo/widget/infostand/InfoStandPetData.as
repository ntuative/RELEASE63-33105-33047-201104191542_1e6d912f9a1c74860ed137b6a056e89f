package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1954 = param1.id;
         this._type = param1.petType;
         this.var_2244 = param1.petRace;
         this.var_49 = param1.image;
         this.var_2246 = param1.isOwnPet;
         this.var_2227 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1398 = param1.level;
         this.var_2226 = param1.levelMax;
         this.var_2224 = param1.experience;
         this.var_2228 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2225 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2222 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2245 = param1.roomIndex;
         this.var_540 = param1.age;
      }
   }
}
