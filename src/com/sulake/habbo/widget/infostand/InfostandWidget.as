package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1821:String = "infostand_user_view";
      
      private const const_1824:String = "infostand_furni_view";
      
      private const const_1825:String = "infostand_pet_view";
      
      private const const_1823:String = "infostand_bot_view";
      
      private const const_1820:String = "infostand_jukebox_view";
      
      private const const_1822:String = "infostand_songdisk_view";
      ...
      private var var_924:InfoStandSongDiskView;
      
      private var var_2382:Array;
      
      private var var_1422:InfostandUserData;
      ...
      private const const_2088:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1146 = new InfoStandFurniView(this,this.const_1824,this._catalog);
         this.var_180 = new InfoStandUserView(this,this.const_1821);
         this.var_348 = new InfoStandPetView(this,this.const_1825,this._catalog);
         this.var_418 = new InfoStandBotView(this,this.const_1823);
         this.var_923 = new InfoStandJukeboxView(this,this.const_1820,this._catalog);
         this.var_924 = new InfoStandSongDiskView(this,this.const_1822,this._catalog);
         this.var_1422 = new InfostandUserData();
         this.var_631 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_161 = new Timer(this.const_2088);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_68,HabboWindowStyle.const_45,HabboWindowParam.const_45,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_159,this.onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_931,this.onBadgeImage);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_372,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_159,this.onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_931,this.onBadgeImage);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_372,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_429,this.var_348.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_751)
         {
            this.var_923.update(param1);
            this.selectView(this.const_1820);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_405) != -1)
         {
            this.var_924.update(param1);
            this.selectView(this.const_1822);
         }
         else
         {
            this.var_1146.update(param1);
            this.selectView(this.const_1824);
         }
         if(this.var_161)
         {
            this.var_161.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1825);
         if(this.var_161)
         {
            this.var_161.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_180.setTags(param1.tags,this.var_2382);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_173:
               ...
               {
                  _loc2_ = param1.id == this.var_1422.userRoomId;
                  break;
               }
      ...
      private function onSongUpdate(param1:RoomWidgetSongUpdateEvent) : void
      {
         ...
         this.var_924.updateSongInfo(param1);
      }
