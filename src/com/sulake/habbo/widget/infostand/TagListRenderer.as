package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2099:int = 5;
      
      private const const_2098:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1186 += param1.height + this.const_2098;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1186);
         this._offsetX += param1.width + this.const_2099;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1598 != null && this.var_1598.indexOf(param1) != -1)
         {
