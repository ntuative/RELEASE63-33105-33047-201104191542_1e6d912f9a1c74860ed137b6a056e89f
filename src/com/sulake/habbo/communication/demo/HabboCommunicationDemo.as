package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_545:IKeyExchange;
      ...
      private const const_1861:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_671 = param1;
            this.var_59.initConnection(HabboConnectionType.const_239);
         }
      }
      ...
      {
         if(this.var_59 && this.var_154 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_671 = this.var_154.getKey("sso.ticket",null);
         this.var_2011 = this.var_154.getKey("flash.client.url","");
         this.var_2795 = this.var_154.getKey("external.variables.txt","");
         if(this.var_232 == null)
         {
            this.var_232 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_59.mode = HabboConnectionType.const_91;
            if(this.var_671)
            {
               this.var_59.initConnection(HabboConnectionType.const_239);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_602,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_59.mode = HabboConnectionType.const_1193;
            }
         }
         this.var_59.initConnection(HabboConnectionType.const_239);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_704);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2793 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_59.mode)
         {
            case HabboConnectionType.const_91:
               ...
               this.var_232.loadBannerImage(_loc7_ + "?token=" + this.var_1572,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1193:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1593:
               this.var_1030 = this.generateRandomHexString(30);
               this.var_545 = new DiffieHellman(new BigInteger(this.var_154.getKey("connection.development.prime"),16),new BigInteger(this.var_154.getKey("connection.development.generator"),16));
               this.var_545.init(this.var_1030);
               _loc8_ = this.var_545.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_545.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_545.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2793);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2011,this.var_2795));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1861,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2794)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_545 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_545.init(_loc14_);
            _loc15_ = this.var_545.getPublicKey(10);
