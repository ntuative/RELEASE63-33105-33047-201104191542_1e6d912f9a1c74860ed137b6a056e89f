package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_602:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_171.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_144,HabboWindowStyle.const_45,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1861,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_171.habboConfiguration.getKey("use.sso","RoomWidgetDimmerUpdateEvent") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1861,"/");
         ...
         {
            dispatchEvent(new Event(const_602));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         if(this.var_144 != null)
         {
            ...
            this.var_144.removeEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
            this.var_144 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_144 = new SSOTicket(this.var_171.assets,_loc3_,_loc2_,param1);
         this.var_144.addEventListener(SSOTicket.const_383,this.onParsedTicketSuccess);
         this.var_144.addEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_171.flashClientUrl = this.var_144.flashClientUrl;
         this.var_171.ssoTicket = this.var_144.ticket;
         this.var_144.removeEventListener(SSOTicket.const_383,this.onParsedTicketSuccess);
         this.var_144.removeEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
         this.var_144 = null;
         dispatchEvent(new Event(const_602));
