package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1693 = int(this.var_195.getKey("latencytest.interval"));
         this.var_1695 = int(this.var_195.getKey("latencytest.report.index"));
         this.var_2256 = int(this.var_195.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1694 > this.var_1693)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_598.add(this.var_1384,this.var_1694);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1384));
         ++this.var_1384;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_598 == null || this.var_220 == null)
         {
            return;
         }
         ...
         if(this.var_220.length == this.var_1695 && this.var_1695 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1696) > this.var_2256 || this.var_1696 == 0)
            {
               this.var_1696 = _loc9_;
