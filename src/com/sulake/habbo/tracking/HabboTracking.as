package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1314:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_141:IHabboHelp;
      ...
      private var var_279:LatencyTracker = null;
      
      private var var_684:LagWarningLogger = null;
      
      private var var_685:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_279 = new LatencyTracker();
         this.var_684 = new LagWarningLogger();
         this.var_685 = new ToolbarClickTracker(this);
         this.var_1601 = new Array(const_1056);
         var _loc4_:int = 0;
         while(_loc4_ < const_1056)
         {
            this.var_1601[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1599,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1505,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_703,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1287,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1314)
            {
               this.var_1314.release(new IIDHabboWindowManager());
               this.var_1314 = null;
            }
            if(this.var_320)
            {
            ...
            if(this.var_215)
            {
               if(!this.var_215.disposed)
               {
                  ...
                  Component(this.var_215).events.removeEventListener(HabboFriendListTrackingEvent.const_376,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_141)
            {
               if(!this.var_141.disposed)
               {
                  this.var_141.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_141.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_141.release(new IIDHabboHelp());
               this.var_141 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_331,this.onRoomAction);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_195)
         {
            ...
            if(this.var_280 != null)
            {
               this.var_280.configuration = this.var_195;
            }
            ...
            if(this.var_195)
            {
               ...
               {
                  this.var_684.configure(this.var_195);
               }
               if(this.var_457 != null)
               {
                  this.var_457.configure(this.var_195);
               }
               if(this.var_685 != null)
               {
                  this.var_685.configure(this.var_195);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_704,this.onConnectionEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_279 != null)
            {
               this.var_279.communication = this._communication;
               this.var_279.connection = param1;
            }
            if(this.var_684 != null)
            {
               this.var_684.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1732);
         }
         else if(param1.type == HabboHotelViewEvent.const_577)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1558);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1672);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1641);
               break;
            case HabboCommunicationEvent.const_704:
               this.trackLoginStep(HabboLoginTrackingStep.const_1525,String(this._communication.port));
               break;
      ...
      {
         this.var_1314 = IHabboWindowManager(param2);
         if(this.var_1314)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_195)
            {
               if(this.var_195.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1601)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_215).events.addEventListener(HabboFriendListTrackingEvent.const_376,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_376:
      ...
      {
         this.var_141 = param2 as IHabboHelp;
         this.var_141.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_141.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1287,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_703,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_331,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_320 = param2 as IAdManager;
         this.var_320.events.addEventListener(AdEvent.const_586,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_330)
         {
            if(this.var_2061 < 1)
            {
               if(!this.var_324)
         ...
         else if(param1.type == RoomEngineEvent.const_331)
         {
            if(this.var_324)
            {
               this.var_324.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_685)
         {
            this.var_685.track(param1.iconName);
         }
      }
      ...
      {
         this.var_684.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2059;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2059);
         }
         if(this.var_556 > -1 && _loc2_ - this.var_556 > 15000)
         {
            ++this.var_2060;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2060);
         }
         this.var_556 = _loc2_;
         if(this.var_280 != null)
         {
            this.var_280.update(param1,this.var_556);
         }
         if(this.var_279 != null)
         {
         ...
         if(this.var_457 != null)
         {
            this.var_457.trackUpdate(param1,this,this.var_556);
         }
         if(this.var_684 != null)
         {
            this.var_684.update(this.var_556);
         }
      }
   }
}
