package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_993:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1359:String = "sendAccessTokenToServer";
      
      private static const const_1358:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1359,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1358,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_993);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_993);
         }
      }
