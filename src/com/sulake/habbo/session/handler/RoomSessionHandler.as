package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1245:String = "RS_CONNECTED";
      
      public static const const_1187:String = "RS_READY";
      
      public static const const_845:String = "RS_DISCONNECTED";
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         if(_loc5_ == null || _loc5_.length == 0)
         {
            if(listener)
            {
               listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_845);
            }
         }
         else if(listener && false)
         {
