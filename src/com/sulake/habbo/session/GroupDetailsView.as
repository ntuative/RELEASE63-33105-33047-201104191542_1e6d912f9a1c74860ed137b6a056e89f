   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(this.var_170 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_170 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_144,HabboWindowStyle.const_30,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
               ...
               for each(_loc6_ in _loc5_)
               {
                  ...
                  if(_loc7_ != null)
                  {
                     ...
                     _loc7_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_6);
                  }
               }
            }
         }
      ...
      private function method_6(param1:WindowEvent) : void
      {
         ...
         var _loc3_:HabboGroupDetails = this._sessionManager.getGroupDetails(this.var_2764);
         switch(_loc2_.name)
         {
