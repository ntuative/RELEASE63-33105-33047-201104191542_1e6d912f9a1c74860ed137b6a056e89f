package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1837)
         {
            this.gotoRoom(this.var_2461,this.var_2460,this.var_1836);
            this.var_1837 = false;
            this.var_1836 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_230,_loc7_));
         return true;
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               ...
               case RoomSessionHandler.const_1187:
                  break;
               case RoomSessionHandler.const_845:
