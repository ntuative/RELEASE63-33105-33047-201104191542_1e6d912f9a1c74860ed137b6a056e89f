package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_441:uint = 3;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_198 = new Array(const_441);
         ...
         this.var_263 = this.var_198[const_1311];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1627)
            {
               this.var_1627 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1627.profiler = _loc3_;
            this.var_1356 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1356);
            this.var_1355 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1355);
            this.var_1083 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_242[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_242[0][param1] as XML : _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1354.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_441 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1354.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_441)
         {
         ...
         this.var_1354.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1553,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1579,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1652,param2.name + ": " + param2.toString());
            }
         }
      }
