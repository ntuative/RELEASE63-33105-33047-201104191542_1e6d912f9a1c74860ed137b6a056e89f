package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1815:String = "badge_bg_001_png";
      
      private const const_2086:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1712 = param6;
         this.var_60 = param10;
         this._assets = param8;
         this.var_417 = param13;
         ...
         this._window.center();
         this.var_2310 = this.var_60.getBadgeName(this.var_293);
         this.var_2314 = this.var_60.getBadgeDesc(this.var_293);
         this.var_2312 = this.var_60.getAchievementNameForFacebook(this.var_293,this.var_417.userName,this.var_417.realName,this.var_1398);
         this.var_2313 = this.var_60.getAchievementDescForFacebook(this.var_293,this.var_417.userName,this.var_417.realName,this.var_1398);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2315 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_60.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1642.toString());
         this.var_60.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1397.toString());
         this.var_60.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1397.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1712;
         var _loc17_:String = this.var_1712 == 0 ? "pixels" : "activitypoints";
         this.var_60.registerParameter(_loc16_,_loc17_,"" + this.var_2309);
         _loc15_.caption = this.var_60.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1815);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2086) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_60.registerParameter(param1,"badge_name",this.var_2310);
         this.var_60.registerParameter(param1,"badge_desc",this.var_2314);
         this.var_60.registerParameter(param1,"badge_name_fb",this.var_2312);
         this.var_60.registerParameter(param1,"badge_desc_fb",this.var_2313);
         this.var_60.registerParameter(param1,"level",this.var_1398.toString());
         this.var_60.registerParameter(param1,"name",this.var_417.userName);
         return this.var_60.registerParameter(param1,"realname",this.var_417.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_417.events.removeEventListener(BadgeImageReadyEvent.const_151,this.onBadgeImageReady);
            this.var_417 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1815);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_293,this._feedTitleFb,this.var_2315,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2311));
