package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_966:int = 3;
      
      private static const const_438:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1618 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1618 = 15;
         }
         this.var_1619 = this._window.height;
         this.var_706 = 4;
         this.var_705 = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_461:
               ...
               _loc2_ = Number(this.var_1081) / Number(this.var_405["time_fade_in"]);
               if(this.var_1081 > int(this.var_405["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_967:
               ...
               if(this.var_1349 > int(this.var_405["time_display"]) && !this.var_1620)
               {
                  this.startFadeOut();
               }
               break;
            case const_966:
               ...
               _loc3_ = 1 - Number(this.var_1082) / Number(this.var_405["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1082 > int(this.var_405["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1618;
         if(this._window.height < this.var_1619)
         {
            this._window.height = this.var_1619;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_438) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_438) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_438) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_438) : int(_loc2_.width);
         if(this.var_405["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_529;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_529;
            }
         }
         else if(this.var_405["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_529;
         }
         else
         ...
         if(this.var_405["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
         ...
         else if(this.var_405["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_706;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_705;
      }
   }
}
