package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1532];
      }
      ...
      public function dispose() : void
      {
         if(this.var_141)
         {
            this.var_141.removeUpdateReceiver(this);
            this.var_141.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_141.toolbar.events.removeEventListener(HabboToolbarEvent.const_930,this.onToolbarResized);
            this.var_141 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_141.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_141.toolbar.events.addEventListener(HabboToolbarEvent.const_930,this.onToolbarResized);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_211.y = this.var_141.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_141.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_141.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,this.current.targetIconId);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_141.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1532 < this._notifications.length - 1)
         {
            ++this.var_1532;
         }
         else
      ...
      {
         this.var_141.removeUpdateReceiver(this);
         this.var_141.registerUpdateReceiver(this,10);
      }
   }
}
