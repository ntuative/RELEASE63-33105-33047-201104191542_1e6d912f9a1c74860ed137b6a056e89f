package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private var var_1123:NameSuggestionListRenderer;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_47.width;
            this._window.content.height = this.var_47.height;
         }
      }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_740)
         {
            this.var_740 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_740)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_740.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_493;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_493);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1063 || param1 == ChangeUserNameResultMessageEvent.var_1066)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1123 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1123.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_493 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_493 != _loc5_)
               {
                  this.var_1715 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_493);
               break;
