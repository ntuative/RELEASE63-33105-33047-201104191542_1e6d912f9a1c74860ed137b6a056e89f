package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_2674:GiftWrappingConfiguration;
      
      private var var_1258:ClubGiftController;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_195.getKey("client.credits.embed.enabled","RoomWidgetDimmerUpdateEvent") == "true";
         if(false && _loc1_)
         {
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_109.getActivityPointsForType(Purse.const_210)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_726)
         {
            if(!this.var_417.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_982;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_273,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1931 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1258 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_373.openPage(this.var_823);
            this.var_823 = "";
            this.var_1006 = -1;
         }
         else if(this.var_1006 > -1)
         {
            this.var_373.openPageById(this.var_1006,this.var_1932);
            this.var_1006 = -1;
            this.var_1932 = -1;
            this.var_823 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2676 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1271);
         }
         this.var_2676 = false;
         if(this.var_315 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2675 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1218);
         }
         this.var_2675 = false;
         if(this.var_315 != null)
         {
         ...
         if(_loc2_.type == Purse.const_210)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1258.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2674 = new GiftWrappingConfiguration(param1);
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1172 || !this.var_1172.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1259 && param1.type == RoomEngineObjectEvent.const_165)
         {
            this.resetPlacedOfferData();
            if(this.var_1007 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_89 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1007);
            _loc2_ = this.var_1534;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_1007.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_305,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_89 != null)
         {
            if(this.var_89.category == RoomObjectCategoryEnum.const_27)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_89 && this.var_89.productClassId == param1.classId)
         {
            if(this.var_89.roomCategory == this._roomEngine.activeRoomCategory && this.var_89.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_311 || param1.category == FurniCategory.const_307 || param1.category == FurniCategory.const_296)
               {
