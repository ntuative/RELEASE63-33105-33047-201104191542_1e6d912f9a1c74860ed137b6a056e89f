package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1798:String = "ctlg_";
      ...
      private var var_1187:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1188);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1188);
      }
      ...
      {
         var _loc2_:String = const_1798 + param1;
         ...
         this.var_1337 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1337) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1653:
               if(this.var_1187 == null)
               {
                  this.var_1187 = new ItemGridCatalogWidget(param1);
                  this.var_39.push(this.var_1187);
               }
               break;
