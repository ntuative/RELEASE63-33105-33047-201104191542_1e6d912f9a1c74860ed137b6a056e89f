package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_610 = this.recycler.getPrizeTable();
         ...
         if(this.var_610.length > 0 && this.var_610[0].prizes.length > 0)
         {
            this.select(this.var_610[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_610.length)
         {
            this.createLevelItem(this.var_610[_loc2_]);
            _loc2_++;
         }
      }
