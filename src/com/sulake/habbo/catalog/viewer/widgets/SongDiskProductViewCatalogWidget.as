package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_450:IButtonWindow;
      ...
      {
         super(param1);
         this.var_450 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1219 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_450 != null)
         {
            this.var_450.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_450.disable();
         }
         this.var_1220 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1220 != null)
         {
            this.var_1220.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_450 != null)
         {
            this.var_450.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_119);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_197);
            this._soundManager.musicController.playSong(this.var_977,HabboMusicPrioritiesEnum.const_197,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_977 = parseInt(_loc2_.extraParam);
            if(this.var_1220 != null)
            {
               this.var_1220.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1219.text = _loc8_;
            }
         }
         else if(this.var_1219 != null)
         {
            this.var_1219.text = "";
         }
         if(this.var_450 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_977);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_977);
         }
         return -1;
      }
