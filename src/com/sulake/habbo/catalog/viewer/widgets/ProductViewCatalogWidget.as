package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1128:ITextWindow;
      
      private var var_85:IBitmapWrapperWindow;
      
      private var var_1726:Point;
      
      private var var_495:IItemGridWindow;
      
      private var var_1405:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_913 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1128 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1726 = new Point(this.var_85.x,this.var_85.y);
         this.var_495 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1405 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1725 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_913.text = _loc4_;
         this.var_1128.text = _loc5_;
         this.var_913.height = this.var_913.textHeight + 5;
         this.var_1128.y = this.var_913.y + this.var_913.height;
         this.var_1128.height = Math.max(130,this.var_1128.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_513:
                  _loc6_ = this.var_1725.clone();
                  if(this.var_495 != null)
                  {
                     this.var_495.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_495,this.var_1405,this.var_1743);
                     ...
                     case ProductTypeEnum.const_207:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_336,AvatarAction.const_499);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1726.x;
            this.var_85.y = this.var_1726.y;
            if(param3 != null)
            {
