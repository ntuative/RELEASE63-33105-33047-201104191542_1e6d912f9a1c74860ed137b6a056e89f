package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_971:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_971.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_971 = null;
         }
         if(this.var_970 != null)
         {
            this.var_970.removeEventListener(WindowKeyboardEvent.const_176,this.windowKeyEventProcessor);
            this.var_970 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_971 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_971 != null)
         {
            this.var_971.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_970 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_970 != null)
         {
            this.var_970.addEventListener(WindowKeyboardEvent.const_176,this.windowKeyEventProcessor);
         }
         return true;
      }
