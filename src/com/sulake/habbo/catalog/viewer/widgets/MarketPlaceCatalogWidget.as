package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2106:int = 40;
      
      private const const_2105:int = 10;
      
      private var var_793:Array;
      
      private var var_1492:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1817,_loc2_.length);
         if(!this.var_513)
         {
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2105;
                  break;
               case "search_input":
                  _loc8_ = this.const_2106;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1492.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
