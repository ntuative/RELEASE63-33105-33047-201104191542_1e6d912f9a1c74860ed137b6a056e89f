package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1462:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_534 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_534 < 8)
         {
            return false;
         }
         this.var_2589 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_208 != null && this.var_208.length > 0)
         {
            this.var_376 = this.var_208[0];
         }
         else
         {
            this.var_376 = -1;
         }
         this._offers.add(this.var_534,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_208 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1462 && _loc2_ < this.var_208.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_534,this.var_208[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_208 != null && this.var_208.length > 0)
         {
            ...
            this.var_376 = this.var_208[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_534,this.var_376),this.getRaceLocalizationKey(this.var_534,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_534,this.var_376);
      }
