package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_981:String = "bg";
      ...
      {
         this._view.getChildByName(const_981).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_981).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         if(this._view)
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_90,MouseCursorType.const_1186);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_590 != null && this.var_590 == param2)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_146)
         {
            this.var_590 = null;
         }
      }
