package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2090:int = 10;
      ...
      private const const_1856:uint = 4.293848814E9;
      
      private const const_1857:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1727 = _loc1_.stuffTypes;
            this.var_757 = _loc1_.boxTypes;
            this.var_756 = _loc1_.ribbonTypes;
            this.var_1148 = this.var_1727[0];
            this.var_351 = this.var_757[0];
            this.var_349 = this.var_756[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_349 < 0)
         {
            this.var_349 = this.var_756.length - 1;
         }
         if(this.var_349 > this.var_756.length - 1)
         {
            this.var_349 = 0;
         }
         if(this.var_351 < 0)
         {
            this.var_351 = this.var_757.length - 1;
         }
         if(this.var_351 > this.var_757.length - 1)
         {
            this.var_351 = 0;
         }
         var _loc1_:int = this.var_757[this.var_351] * 1000 + this.var_756[this.var_349];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1148,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1425 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1727;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1148);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_757[this.var_351]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_756[this.var_349]);
         this._catalog.purchaseProductAsGift(this.var_1426,this.var_92,this.var_1424,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1426,this.var_92.offerId,this.var_1424);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               if(this.var_2389 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_219)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2090)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2389 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_317:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_254 == null || this.var_612 == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1856) : uint(this.const_1857);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1148;
               }
            }
            _loc4_++;
         }
