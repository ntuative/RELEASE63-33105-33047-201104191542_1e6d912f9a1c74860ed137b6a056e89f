package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_643 != const_1033;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1874 != RecyclerStatusMessageEvent.const_1148;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_643 == const_449;
      }
      ...
      {
         this.var_643 = const_1034;
         this.var_121 = new Array(const_196);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1874)
         {
            case RecyclerStatusMessageEvent.const_1502:
               this.var_643 = const_449;
            ...
            case RecyclerStatusMessageEvent.const_1148:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1645:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1102:
               if(this._view != null)
               {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_121.length < const_196)
         {
            return false;
         }
         var _loc1_:int = 0;
