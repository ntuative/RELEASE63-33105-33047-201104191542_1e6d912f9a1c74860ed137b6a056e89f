package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1360:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1410:XML;
      
      private static var var_1408:XML;
       
      
      private var var_1737:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1408 == null)
         {
            ...
            var_1408 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1737 == 4294967295)
            {
               this.var_1737 = _loc1_.color;
            }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1708;
            }
         }
      }
      ...
      {
         this.var_61 = navigator.catalog.windowManager.buildFromXML(var_1408) as IItemListWindow;
         if(this.var_61 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1410) as IWindowContainer;
         }
         else
         {
