package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2955:String = "magic.pixels";
      
      private var var_2956:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2955);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2956,true);
      }
