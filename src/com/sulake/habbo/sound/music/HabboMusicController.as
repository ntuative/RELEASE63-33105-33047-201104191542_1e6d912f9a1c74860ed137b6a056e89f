package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1481:int = HabboMusicPrioritiesEnum.const_119;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_783.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_783.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_783)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_954,this.onJukeboxInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_260,this.onJukeboxDispose);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachineInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_786,this.onSoundMachineDispose);
         this.var_1297 = new Timer(1000);
         this.var_1297.start();
         this.var_1297.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_254)
         {
            this.var_548[_loc6_] = null;
            this.var_841[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2029)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_375)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_500,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_783)
               {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_453.length)
               {
                  _loc3_ = this.var_453.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_954,this.onJukeboxInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_260,this.onJukeboxDispose);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachineInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_786,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_254)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_548[param1] = _loc7_;
         this.var_841[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_548[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_548[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_841[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_548.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_548[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_453.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_254)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_676.add(param1,param2);
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_840));
         Logger.log("Requested song info\'s : " + this.var_840);
         this.var_840 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_453.add(_loc6_.id,_loc10_);
               ...
               while(this.var_839.indexOf(_loc6_.id) != -1)
               {
                  ...
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_454));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_254)
         {
            return false;
         }
         ...
         this.var_2029 = this.getSongRequestCountAtPriority(param1);
         this.var_2030 = param2;
         if(this._priorityPlaying <= const_1481)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_119)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_473,param1,_loc4_.id,-1));
         }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_676.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            if(this.var_453.getValue(_loc6_) == null)
            {
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_547 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
