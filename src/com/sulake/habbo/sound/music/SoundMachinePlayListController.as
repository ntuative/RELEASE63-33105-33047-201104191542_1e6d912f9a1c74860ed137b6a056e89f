package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_73:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_73 = param2;
         this.var_783 = [];
         this.var_783.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_783.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_783)
         {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_776,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_943,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_776,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_943,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_465 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_73.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_465 = -1;
         this.var_691 = false;
         this.var_73.stop(HabboMusicPrioritiesEnum.const_119);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_73.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_73.playSong(param1,HabboMusicPrioritiesEnum.const_119,_loc3_,0,0,0))
         {
