package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_2866:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_145 = param1;
         this.var_2051 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_61 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2866 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1055 + const_1486)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1485;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_2051.enable();
         }
         else
         {
            this.var_2051.disable();
         }
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_902 || param3.type == Message.const_825 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_145.send(new FollowFriendMessageComposer(this.var_551.id));
      }
