package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_484:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_484 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_110 is BitmapDataAsset)
         {
            ...
            this.var_1555 = BitmapDataAsset(this.var_110).var_1555;
            this.var_1554 = BitmapDataAsset(this.var_110).var_1554;
            if(this._bitmap != null)
            {
               this.var_110 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1555 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1554 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
