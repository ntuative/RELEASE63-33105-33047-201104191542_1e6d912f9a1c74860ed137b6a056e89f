package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_942:String = "AssetLibraryLoaded";
      
      public static const const_1781:String = "AssetLibraryUnloaded";
      
      public static const const_1790:String = "AssetLibraryLoadError";
      
      private static const const_440:String = "name";
      
      private static const const_1057:String = "asset";
      ...
      private static var var_2073:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      private var var_462:uint;
      
      private var var_45:LibraryLoader;
      
      private var var_689:Class;
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_690 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1057);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_440);
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_690 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1055.splice(var_1055.indexOf(this),1);
            --var_558;
            this.var_559 = null;
            this.var_1056 = null;
            this.var_173 = null;
      ...
      {
         if(this.var_690 == param1.url && this.var_1057)
         {
            if(!this.var_1058 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_689);
            }
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_462;
                     this.var_460.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_460.length ? this.getAssetByName(this.var_460[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_173)
         {
            ...
            {
               return this.var_460.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_173[param1] != null || (this.var_689 != null ? this.var_689[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2073.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_173)
            {
               if(this.var_173[_loc2_] == param1)
               {
                  this.var_460.splice(this.var_460.indexOf(_loc2_),1);
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_689 = _loc2_.resource;
         this.var_690 = _loc2_.url;
         if(this.var_1058)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_689);
         }
         this.var_1057 = true;
         dispatchEvent(new Event(AssetLibrary.const_942));
         dispatchEvent(new Event(AssetLibrary.const_1105));
         if(this.var_1058)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1790));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1057);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_440).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_690 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_689[param1]);
