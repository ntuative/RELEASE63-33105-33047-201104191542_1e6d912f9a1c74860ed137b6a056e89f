package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_332 = new Array();
            var_332[0] = MouseCursorType.const_302;
            var_332[1] = MouseCursorType.const_30;
            var_332[2] = MouseCursorType.const_302;
            var_332[3] = MouseCursorType.const_302;
            var_332[4] = MouseCursorType.const_302;
            var_332[5] = MouseCursorType.const_30;
            var_332[6] = MouseCursorType.const_302;
         }
         if(var_287 == null)
         {
            var_287 = new Array();
            ...
            var_287[2] = WindowState.const_90;
            var_287[3] = WindowState.const_73;
            var_287[4] = WindowState.const_53;
            var_287[5] = WindowState.const_93;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_65 = state.var_1324 as WindowController;
         this.var_176 = state.var_1322 as WindowController;
         this.var_167 = state.renderer;
         this.var_874 = state.var_1319;
         eventQueue.begin();
         this.var_698.x = -1;
         this.var_698.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_698.x || event.stageY != this.var_698.y)
            {
               ...
               array = new Array();
               this.var_83.groupParameterFilteredChildrenUnderPoint(this.var_698,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_65 && !this.var_65.disposed)
                     {
                        ...
                        {
                           this.var_874.mouseEventReceived(event.type,this.var_65);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1324 = this.var_65;
         state.var_1322 = this.var_176;
         state.renderer = this.var_167;
         state.var_1319 = this.var_874;
      }
