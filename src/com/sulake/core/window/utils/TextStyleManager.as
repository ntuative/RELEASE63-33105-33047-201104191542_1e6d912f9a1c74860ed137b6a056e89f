package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_659) != countSubStrings(param1,const_660))
         {
            throw new Error("Mismatching amount of \"" + const_659 + "\" versus \"" + const_660 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1444) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1443) + 2,_loc5_.length);
            }
