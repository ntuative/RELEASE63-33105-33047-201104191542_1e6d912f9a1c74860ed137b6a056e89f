package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1924:String = "_TEMP";
      
      private static const const_1339:String = "layout";
      
      private static const const_991:String = "window";
      
      private static const const_990:String = "variables";
      ...
      private static const const_1338:String = "visible";
      ...
      private static const const_1072:String = "blend";
      
      private static const const_1348:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1342:String = "treshold";
      
      private static const const_1344:String = "children";
      
      private static const const_1346:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1343:String = "height_min";
      
      private static const const_1347:String = "height_max";
      
      private static const const_644:String = "true";
      ...
      protected var var_1607:Dictionary;
      
      protected var var_2117:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1325,this.var_1326);
         this.var_1067 = new Dictionary();
         this.var_1607 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1067,this.var_1607);
         this.var_2117 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1334,const_49);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1607)
            {
               delete this.var_1607[_loc1_];
            }
            this.var_2117.dispose();
            this.var_2117 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1339)
         {
            _loc8_ = param1.child(const_990);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1325[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_440,variables,"")));
         ...
         visible = this.parseAttribute(xml,const_1338,variables,visible.toString()) == const_644;
         ...
         if(xml.child(const_645).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_440,variables,"") as String;
               if(this.var_1067[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_440)) + "\"!");
               }
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_990)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1346,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1343,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1347,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_644;
         blend = Number(this.parseAttribute(xml,const_1072,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1348,variables,window.clipping.toString()) == const_644;
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1326[param1.type];
