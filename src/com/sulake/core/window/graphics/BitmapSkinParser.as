   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_395 = SkinLayoutEntity.const_593;
                  break;
               case "move":
                  _loc5_.var_395 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_395 = SkinLayoutEntity.const_469;
                  break;
               case "tiled":
                  _loc5_.var_395 = SkinLayoutEntity.const_298;
                  break;
               case "center":
                  _loc5_.var_395 = SkinLayoutEntity.const_1210;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_593;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_469;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_298;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1210;
            }
         }
