package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1676:uint = 0;
      
      public static const const_740:uint = 1;
      
      public static const const_1078:uint = 2;
      
      public static const const_932:uint = 4;
      
      public static const const_1515:uint = 8;
      
      public static const const_1718:uint = 16;
      
      public static const const_1935:uint = 64;
      
      public static const const_1976:uint = 128;
      
      public static const const_1135:uint = 256;
      
      protected static var var_572:uint = 0;
      
      protected static var var_330:uint = 0;
         ...
         if(this.var_869)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_330 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2129,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2129,16777215);
                  }
                  var_330 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_869)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_330 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
