package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1040:uint = 8;
      
      private static const const_1448:String = "skin";
      
      private static const const_1451:String = "bitmap";
      
      private static const const_1453:String = "fill";
      
      private static const const_1449:String = "text";
      
      private static const const_1450:String = "label";
      
      private static const const_1452:String = "shape";
      ...
      private var var_2586:Dictionary;
      
      private var var_2585:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2586 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1896,this.var_2586);
         this.var_2585 = new Dictionary();
         this.var_2584 = new Dictionary();
         StateCodeTable.fillTables(this.var_2585,this.var_2584);
         this.var_438 = new Dictionary();
         this.var_438[const_1448] = BitmapSkinRenderer;
         this.var_438[const_1451] = BitmapDataRenderer;
         this.var_438[const_1453] = FillSkinRenderer;
         this.var_438[const_1449] = TextSkinRenderer;
         this.var_438[const_1450] = LabelRenderer;
         this.var_438[const_1452] = ShapeSkinRenderer;
         this.var_438[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_438[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_331 == null)
         {
            var_331 = new Array();
            var_331.push(WindowState.const_73);
            var_331.push(WindowState.const_84);
            var_331.push(WindowState.const_93);
            var_331.push(WindowState.const_53);
            var_331.push(WindowState.const_90);
            var_331.push(WindowState.const_85);
            var_331.push(WindowState.const_108);
            var_331.push(WindowState.const_99);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2893 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1896[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_989[param1] == null)
         {
            this.var_989[param1] = new Array(const_1040);
         }
         this.var_989[param1][param2] = param3;
         if(this.var_990[param1] == null)
         {
            this.var_990[param1] = new Array(const_1040);
         }
         this.var_990[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_989[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_990[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_177)
