package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_621)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_621)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_728,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1657);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1116)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_885,param1.toolTipDelay,PropertyStruct.const_249,true));
         }
         else
         {
