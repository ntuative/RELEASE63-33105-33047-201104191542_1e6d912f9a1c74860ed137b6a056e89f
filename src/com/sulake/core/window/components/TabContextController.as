package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1437:String = "_SELECTOR";
      
      private static const const_1438:String = "_CONTENT";
       
      
      protected var var_1073:ITabSelectorWindow;
      
      protected var var_2128:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1073 = findChildByTag(const_1437) as ITabSelectorWindow;
            if(this.var_1073 != null)
            {
               this.var_1073.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2128 = findChildByTag(const_1438) as IWindowContainer;
         }
      ...
      {
         return this.var_1073.numSelectables;
      }
