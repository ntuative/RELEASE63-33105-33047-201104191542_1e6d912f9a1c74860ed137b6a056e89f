package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_947:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_948:String = "default";
      
      private var var_1179:String = null;
      
      private var var_1819:StyleSheet = null;
      ...
      {
         return this.var_948 == LinkTarget.const_30 ? defaultLinkTarget : this.var_948;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1819;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_948 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_790,this.var_948,PropertyStruct.const_54,true,PropertyDefaults.const_748));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_948 = _loc2_.value as String;
               break;
            }
