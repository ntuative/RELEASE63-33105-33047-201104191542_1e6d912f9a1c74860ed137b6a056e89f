package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1300:Dictionary = method_9();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_437,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_437 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_437,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_791 ? true : null;
         }
      ...
      protected static function method_9() : Dictionary
      {
      ...
      {
         return new Rectangle(this.var_873 * this.maxScrollH,this.var_566 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1208) ? new PropertyStruct(PropertyDefaults.const_896,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1278) : PropertyDefaults.const_1688);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1111 ? new PropertyStruct(PropertyDefaults.const_937,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1265) : PropertyDefaults.const_1756);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_40,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_154,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1098 ? new PropertyStruct(PropertyDefaults.const_1264,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1207) : PropertyDefaults.const_1748);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_803) ? new PropertyStruct(PropertyDefaults.const_416,this._field.textColor,PropertyStruct.const_154,true) : PropertyDefaults.const_1194);
         ...
         _loc1_.push(this.var_44.left != PropertyDefaults.const_940 ? new PropertyStruct(PropertyDefaults.const_264,this.var_44.left,PropertyStruct.const_43,true) : PropertyDefaults.const_511);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_860 ? new PropertyStruct(PropertyDefaults.const_236,this.var_44.top,PropertyStruct.const_43,true) : PropertyDefaults.const_559);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_923 ? new PropertyStruct(PropertyDefaults.const_248,this.var_44.right,PropertyStruct.const_43,true) : PropertyDefaults.const_614);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_846 ? new PropertyStruct(PropertyDefaults.const_243,this.var_44.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_453);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1156 ? new PropertyStruct(PropertyDefaults.const_686,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1609);
