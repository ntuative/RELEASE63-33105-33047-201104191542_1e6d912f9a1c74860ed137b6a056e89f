package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1078,var_11);
         }
         return var_21;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_176,event,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_870,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1534);
         _loc1_.push(this.var_1332 != PropertyDefaults.const_1096 ? new PropertyStruct(PropertyDefaults.const_898,this.var_1332,PropertyStruct.const_40,true) : PropertyDefaults.const_1776);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1283 ? new PropertyStruct(PropertyDefaults.const_727,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1544);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1258 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1619);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_898:
                  this.var_1332 = _loc2_.value as Boolean;
                  if(this.var_1332)
                  {
               ...
               case PropertyDefaults.const_870:
                  ...
                  break;
               case PropertyDefaults.const_1089:
