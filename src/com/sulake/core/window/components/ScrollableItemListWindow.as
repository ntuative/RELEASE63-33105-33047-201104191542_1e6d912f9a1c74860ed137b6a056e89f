package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_452)
         {
            this.var_452.removeEventListener(WindowEvent.const_271,this.scrollBarEventProc);
            this.var_452.removeEventListener(WindowEvent.const_185,this.scrollBarEventProc);
            this.var_452 = null;
         }
         if(this.var_1296)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_452)
         {
            ...
            if(this.var_452)
            {
               this.var_452.addEventListener(WindowEvent.const_271,this.scrollBarEventProc);
               this.var_452.addEventListener(WindowEvent.const_185,this.scrollBarEventProc);
            }
         }
         return this.var_452;
      }
