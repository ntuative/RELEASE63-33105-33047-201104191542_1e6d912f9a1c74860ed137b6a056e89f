package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1458:String = "_TITLE";
      
      private static const const_1465:String = "_HEADER";
      
      private static const const_1464:String = "_CONTENT";
      
      private static const const_1463:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1548:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1458) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1548 = findChildByTag(const_1465) as IHeaderWindow;
            if(!this.var_1548)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_179 = findChildByTag(const_1464) as IWindowContainer;
            if(!this.var_179)
            {
      ...
      {
         return findChildByTag(const_1463) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1299,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_276);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_276,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_276,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
