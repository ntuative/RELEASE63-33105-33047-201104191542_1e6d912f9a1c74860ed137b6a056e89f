package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_437:String = "_DROPMENU_TITLETEXT";
      ...
      {
         return getChildByName(DropMenuController.const_437) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_193 == null || this.var_193.disposed)
         {
            this.var_193 = context.create(name + "::submenu","",WindowType.const_619,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1039 = false;
            this.getTitleLabel().text = this.var_677 < this.var_275.length && this.var_677 > -1 ? this.var_275[this.var_677] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         {
            _loc4_.getListItemAt(this.var_677).setStateFlag(WindowState.const_53,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_718)
         {
      ...
      public function close() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1570,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_275.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_874,this.var_275,PropertyStruct.const_136,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_874)
            {
