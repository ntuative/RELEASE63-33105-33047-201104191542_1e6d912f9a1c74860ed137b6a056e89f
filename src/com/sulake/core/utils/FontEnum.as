package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_665:Map = new Map();
      
      private static const const_360:Map = new Map();
      
      private static var var_1256:Boolean = false;
      ...
      {
         return const_665.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1256)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_665.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1256 = true;
         }
