package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1805:uint = 1;
      
      protected static const const_1802:uint = 2;
      
      protected static const const_1803:uint = 4;
      
      protected static const const_1804:uint = 3;
      ...
      public static const const_1205:Boolean = false;
      
      public static const const_1786:int = 2;
      
      private static var var_1004:Array = new Array();
      
      private static var var_820:Array = new Array();
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_45.load(param1.var_239,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1205)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_820[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_820.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_820.length < const_1786 && false)
            {
               _loc1_ = var_1004.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_820.push(_loc1_);
                  _loc1_.var_45.load(_loc1_.var_239,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1077 ? uint(this.var_1336 - this.var_2130) : uint(getTimer() - this.var_2130);
      }
      ...
      {
         if(!this.var_1077 && !_disposed && this.var_1335 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1581 - this.var_1335);
            if(this.var_2913)
            {
            ...
            --this.var_1335;
            this.var_471 = 0;
            this.var_45.load(this.var_239,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_471 == LibraryLoader.const_1804)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_689 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_689.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
